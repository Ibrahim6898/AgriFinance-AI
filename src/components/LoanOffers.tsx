        ...
        >
          ...
          >
            <div className="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50">
              <h4 className="font-bold text-[#2D6A4F]">{t('loan_modal_title')}</h4>
            ...
            <div className="p-6">
              {showSuccess ? (
                <div className="text-center">
                  ...
                  <h4 className="font-bold text-lg text-slate-800 mb-2">{t('loan_modal_initiated')}</h4>
                  <p className="text-sm text-gray-600 mb-4">
                    {t('loan_modal_initiated_desc')} <strong>{selectedOffer.lender}</strong>, {t('loan_modal_initiated_suffix')}
                  </p>
                  <div className="bg-gray-50 p-4 rounded-lg text-left text-sm space-y-3">
                    <div>
                      <span className="block text-gray-500 text-xs uppercase tracking-wider font-bold mb-1">{t('loan_modal_option1')}</span>
                    ...
                    <div>
                      <span className="block text-gray-500 text-xs uppercase tracking-wider font-bold mb-1">{t('loan_modal_option2')}</span>
                ...
                <div className="space-y-4">
                  <div>
                    <p className="text-xs text-gray-500 uppercase tracking-wider font-bold">{t('loan_modal_lender')}</p>
                    <p className="font-bold text-lg text-slate-800">{selectedOffer.lender}</p>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <p className="text-xs text-gray-500 uppercase tracking-wider font-bold">{t('loan_modal_type')}</p>
                      <p className="font-medium text-slate-800">{selectedOffer.type}</p>
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 uppercase tracking-wider font-bold">{t('loan_modal_rate')}</p>
                      <p className="font-medium text-slate-800">{selectedOffer.rate}</p>
                    </div>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500 uppercase tracking-wider font-bold">{t('loan_modal_amount')}</p>
